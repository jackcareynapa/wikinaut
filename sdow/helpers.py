...
def get_sanitized_page_title(page_title):
  ...
  Spaces become underscores and quotes are backslash-escaped. Slashes are left alone: they are
  legal in stored titles (e.g. "Nip/Tuck" stays "Nip/Tuck").
...
def get_readable_page_title(sanitized_page_title):
  ...
  Args:
    sanitized_page_title: The sanitized page title to make human-readable.
